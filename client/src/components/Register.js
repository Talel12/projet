...
class Register extends Component {
    ...
    render (){ 
        ...
        <div className='register'><h1>inscription</h1>
            ...
            <input name="email" type="text" onChange={this.handelChange}placeholder="votre email"/>
            <input name="adress" type="text" onChange={this.handelChange}placeholder="votre adresse"/>
            <input name="cin" type="text" onChange={this.handelChange}placeholder="votre cin"/>
            <input name="numtel" type="text" onChange={this.handelChange}placeholder="votre numéro de téléphone"/>
